...
public class ListTacGiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tacGiaArrayList.add(new TacGia(R.drawable.tohuu,"Tố Hữu","Nhà Văn","","Việt Nam"));
        tacGiaArrayList.add(new TacGia(R.drawable.hemingway,"Hemingway","Nhà Văn","","Pháp"));
        tacGiaArrayList.add(new TacGia(R.drawable.huycan,"Huy Cận","Nhà Văn","","Việt Nam"));
        tacGiaArrayList.add(new TacGia(R.drawable.macngon,"Mạc Ngôn","Nhà Văn","","Trung Quốc"));
        tacGiaArrayList.add(new TacGia(R.drawable.shakespeare,"Shakespeare","Nhà Văn","","Anh"));
